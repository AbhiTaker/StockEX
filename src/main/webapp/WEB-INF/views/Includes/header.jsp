    ...
    -->
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <c:if test = "${usertype == 'client'}">
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="componentsExamples">
                                <ul class="nav">
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/stockex/trade">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/stockex/opentrade">
                                            ...
                                            <span class="sidebar-normal">Open Trades</span>
                                        </a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/stockex/history">
                                            <span class="sidebar-mini">TH</span>
                                            <span class="sidebar-normal">Trade History</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/stockex/research">
                    ...
                    <c:if test = "${usertype == 'admin'}">
                        <li class="nav-item">
                            <a class="nav-link" href="/stockex/addstock">
